...
all: part2Test part3Test part4Test csv2heapfile scan insert update delete select part5Timer
...
clean:
	rm -f part*Test part5Timer csv2heapfile insert scan update delete select *.o 
