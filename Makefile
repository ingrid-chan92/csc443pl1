...
all: csv2heapfile scan insert update delete select timer write_fixed_len_pages read_fixed_len_page
...
clean:
	rm -f timer csv2heapfile insert scan update delete select *.o 
